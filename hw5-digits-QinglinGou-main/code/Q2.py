...
plt.plot(max_depth, train_scores.mean(axis=1), color="darkorange",label="Training error")
plt.fill_between(
    max_depth,
...
plt.plot(max_depth, test_scores.mean(axis=1), color="navy",label="Testing error")
plt.legend()

plt.xlabel("Maximum depth of decision tree")
plt.ylabel("Accuracy")
_ = plt.title("Validation curve for decision tree")
plt.savefig("figs/Validation curve for decision tree.png")
plt.show()
...
a=int(str(best_parameters)[14:-1])
